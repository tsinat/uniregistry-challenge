            ...
            <div className="container">
                <form className="form-detail clearfix">
                    ...
                    <div className="col-xs-9">
                        <input type="text" name="domain" value={this.state.domain} onChange={this.handleChange} className="form-control col-xs-6" id="name"/>
                    </div>
                    <div className="col-xs-3">
                        <label className="">Registrant Email</label>
                    </div>
                    <div className="col-xs-9">
                        <input type="text" name="email" value={this.state.email} onChange={this.handleChange} className="form-control" id="email"/>
                    </div>
                    <div className="col-xs-3">
                        <label className="">Price</label>
                    </div>
                    <div className="col-xs-9">
                        <input type="text" name="price" value={`${price}`} onChange={this.handleChange} className="form-control" id="price"/>
                    </div>
